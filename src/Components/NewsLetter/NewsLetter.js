        ...
        <div className="lg:flex justify-start lg:gap-28">
          <div className>
            ...
            <div className="mt-8 md:flex justify-start md:gap-4">
              ...
              <button
                onClick={thanks}
                className="w-full md:w-auto bg-green-600 text-white px-8 py-4 border rounded-md hover:bg-green-700 grid place-items-center font-semibold mt-4 md:mt-0 focus:outline-none focus:ring-2 focus:ring-indigo-700 focus:ring-opacity-50"
              >
                Subscribe
              </button>
            </div>
