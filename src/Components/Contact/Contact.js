        ...
        <div className="xl:w-2/5 lg:w-2/5 bg-green-700 py-16 xl:rounded-bl rounded-tl rounded-tr xl:rounded-tr-none">
          <div className="xl:w-5/6 xl:px-0 px-8 mx-auto">
            ...
            <div className="flex pb-4 items-center">
              ...
              <p className="pl-4 text-white text-base">+88 (017) 0187 321</p>
            </div>
            <div className="flex items-center">
              ...
              <p className="pl-4 text-white text-base">info@gadhope.web.app</p>
            </div>
            <p className="text-lg text-white pt-10 tracking-wide">
              51/A, West Raza Bazar, Panthapath <br />
              Dhaka, Bangladesh
            </p>
            <Link to={'/blog'}>
              ...
              <div className="w-2/4 max-w-xs mb-6 xl:mb-0">
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    name="full_name"
                    type="text"
                    className="focus:outline-none focus:border focus:border-green-700 font-normal w-64 h-10 flex items-center pl-3 text-sm border-gray-300 rounded border"
                    placeholder
                  />
                </div>
              </div>
            ...
            <div className="w-full mt-6">
              <div className="flex flex-col">
                ...
                <textarea
                  placeholder
                  name="message"
                  className="border-gray-300 border mb-4 rounded py-2 text-sm outline-none resize-none px-3 focus:border focus:border-green-700"
                  rows={8}
                  id="message"
                  defaultValue={""}
                />
              ...
              <button
                type="submit"
                className="focus:outline-none bg-green-700 transition duration-150 ease-in-out hover:bg-green-600 rounded text-white px-8 py-3 text-sm leading-6"
              >
                Submit
              </button>
            </div>
